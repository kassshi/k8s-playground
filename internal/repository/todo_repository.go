...
func (r *TodoRepository) DeleteTodo(ctx context.Context, id pgtype.UUID) error {
	return r.querier.DeleteTodo(ctx, id)
}
func (r *TodoRepository) GetTodoByID(ctx context.Context, id pgtype.UUID) (sqlc.Todo, error) {
	return r.querier.GetTodoByID(ctx, id)
}
