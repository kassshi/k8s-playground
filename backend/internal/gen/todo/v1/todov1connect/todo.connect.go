...
type TodoServiceClient interface {
	CreateTodo(context.Context, *connect.Request[v1.CreateTodoRequest]) (*connect.Response[v1.Todo], error)
	GetTodo(context.Context, *connect.Request[v1.GetTodoRequest]) (*connect.Response[v1.Todo], error)
	UpdateTodo(context.Context, *connect.Request[v1.UpdateTodoRequest]) (*connect.Response[v1.Todo], error)
	DeleteTodo(context.Context, *connect.Request[v1.DeleteTodoRequest]) (*connect.Response[emptypb.Empty], error)
	ListTodos(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[v1.ListTodosResponse], error)
}
...
func NewTodoServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TodoServiceClient {
	...
	return &todoServiceClient{
		...
		listTodos: connect.NewClient[emptypb.Empty, v1.ListTodosResponse](
			httpClient,
...
type todoServiceClient struct {
	createTodo *connect.Client[v1.CreateTodoRequest, v1.Todo]
	getTodo    *connect.Client[v1.GetTodoRequest, v1.Todo]
	updateTodo *connect.Client[v1.UpdateTodoRequest, v1.Todo]
	deleteTodo *connect.Client[v1.DeleteTodoRequest, emptypb.Empty]
	listTodos  *connect.Client[emptypb.Empty, v1.ListTodosResponse]
}

// CreateTodo calls todo.v1.TodoService.CreateTodo.
func (c *todoServiceClient) CreateTodo(ctx context.Context, req *connect.Request[v1.CreateTodoRequest]) (*connect.Response[v1.Todo], error) {
	return c.createTodo.CallUnary(ctx, req)
}

// GetTodo calls todo.v1.TodoService.GetTodo.
func (c *todoServiceClient) GetTodo(ctx context.Context, req *connect.Request[v1.GetTodoRequest]) (*connect.Response[v1.Todo], error) {
	return c.getTodo.CallUnary(ctx, req)
}

// UpdateTodo calls todo.v1.TodoService.UpdateTodo.
func (c *todoServiceClient) UpdateTodo(ctx context.Context, req *connect.Request[v1.UpdateTodoRequest]) (*connect.Response[v1.Todo], error) {
...
func (c *todoServiceClient) ListTodos(ctx context.Context, req *connect.Request[emptypb.Empty]) (*connect.Response[v1.ListTodosResponse], error) {
...
func (UnimplementedTodoServiceHandler) CreateTodo(context.Context, *connect.Request[v1.CreateTodoRequest]) (*connect.Response[v1.Todo], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("todo.v1.TodoService.CreateTodo is not implemented"))
}

func (UnimplementedTodoServiceHandler) GetTodo(context.Context, *connect.Request[v1.GetTodoRequest]) (*connect.Response[v1.Todo], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("todo.v1.TodoService.GetTodo is not implemented"))
}

func (UnimplementedTodoServiceHandler) UpdateTodo(context.Context, *connect.Request[v1.UpdateTodoRequest]) (*connect.Response[v1.Todo], error) {
...
func (UnimplementedTodoServiceHandler) ListTodos(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[v1.ListTodosResponse], error) {
